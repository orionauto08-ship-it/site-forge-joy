...
const directions = [
  ...
  { i: Car, t: "Автомобили под заказ", d: "Подбор и поставка из Европы и Азии по вашим параметрам. Полный цикл: от поиска до таможни." },
];
...
const audiences = [
  ...
  { i: Users, t: "Корпоративные автопарки", d: "Регулярные закупки с чёткими условиями." },
];
...
const principles = [
  ...
  { t: "Экспертиза", d: "Подбор не по каталогу, а с учётом реальных задач." },
  { t: "Стабильность", d: "Для СТО: скидки до 15% за объём, регулярные поставки." },
];
