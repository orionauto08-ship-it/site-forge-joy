...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Поставщик оригинальных запчастей, химии Diamond ProTech и автомобилей под заказ. Только оригинал, подтверждённый документами." },
      { property: "og:title", content: "Орионавто — ориентир в автомобильном мире" },
      { property: "og:description", content: "20 лет в автобизнесе. Оригинал с документами, подбор запчастей и авто под ключ." },
    ],
  }),
  component: AboutPage,
});
    ...
    <Layout>
      ...
      <section className="container-page mt-12 grid md:grid-cols-3 gap-4">
        {[
          ...
          { n: "9+", t: "брендов по запчастям", d: "Привозим оригинальные запчасти для BYD, Zeekr, LiXiang, Changan, Chery, Voyah, Deepal, Leapmotor, Xiaomi и др." },
