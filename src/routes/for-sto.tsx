...
export const Route = createFileRoute("/for-sto")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Надёжный поставщик для станций технического обслуживания. Только оригинал, подтверждённый документами, с подбором и скидками за объём до 15%." },
    ],
  }),
  component: StoPage,
});
...
const why = [
  ...
  { i: Award, t: "Опыт команды", d: "Специалисты с 20-летним стажем у официальных дилеров. Знают совместимость, нюансы подбора и типичные ошибки." },
];

const conditions = [
  { i: Percent, t: "Скидка до 15% за объём", d: "При регулярных закупках обсуждаем индивидуальные условия." },
  { i: Boxes, t: "Быстрые позиции в наличии", d: "Масла, жидкости, группа ТО — без ожидания." },
  { i: Plane, t: "Под заказ — по договорённости", d: "Точные сроки согласовываем перед заказом. Авиадоставка из Китая 14 дней — для гарантийных кейсов." },
...
const faq = [
  { q: "Какие скидки для СТО?", a: "До 15% при регулярных закупках. Условия обсуждаем индивидуально." },
  ...
  { q: "Какие бренды в приоритете?", a: "BYD, Zeekr, Changan, Chery, Volkswagen, Mazda, Kia, Renault и др." },
