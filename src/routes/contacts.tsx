      ...
      <section className="container-page mt-10 grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          {[
            ...
            <a key={c.t} href={c.href} target={(c as any).target} rel={(c as any).rel} className="block rounded-2xl bg-card border border-border p-6 hover:-translate-y-0.5 transition-transform">
