        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              t: "Diamond ProTech",
              d: "Профессиональная химия и керамические покрытия для детейлинг-студий. Эксклюзив РБ/РФ.",
              to: "/diamond-protech",
      ...
      <section className="container-page mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            { t: "Автовладельцы", d: "Точный подбор оригинала с документами подлинности и прозрачными сроками. Поможем выбрать и привезти именно тот автомобиль, который хотите вы.", to: "/parts", cta: "Подобрать запчасть" },
